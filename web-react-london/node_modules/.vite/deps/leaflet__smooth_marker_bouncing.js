// node_modules/leaflet.smooth_marker_bouncing/dist/bundle.js
(function(L2) {
  "use strict";
  function _interopDefaultLegacy(e) {
    return e && typeof e === "object" && "default" in e ? e : { "default": e };
  }
  var L__default = _interopDefaultLegacy(L2);
  ...
  var BouncingOptions = function() {
    function BouncingOptions2(options) {
      _classCallCheck(this, BouncingOptions2);
    ...
    _createClass(BouncingOptions2, [{
      key: "override",
      value: function override(options) {
        return Object.assign(new BouncingOptions2(this), options);
      }
    }]);
    return BouncingOptions2;
  }();
  var _bouncingMarkers = /* @__PURE__ */ new WeakMap();
  var Orchestration = function() {
    function Orchestration2() {
      _classCallCheck(this, Orchestration2);
      _classPrivateFieldInitSpec(this, _bouncingMarkers, {
        writable: true,
        value: []
      });
    }
    _createClass(Orchestration2, [{
  ...
  var oldSetPos = L2.Marker.prototype._setPos;
  var oldOnAdd = L2.Marker.prototype.onAdd;
  var oldSetIcon = L2.Marker.prototype.setIcon;
  var MarkerPrototypeExt = {
    ...
    bounce: function bounce() {
      var _this = this;
      var times = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null;
      if (times) {
        this._bouncingMotion.onMotionEnd = function() {
          L2.Marker.prototype._orchestration.removeBouncingMarker(_this);
        };
      }
      this._bouncingMotion.bounce(times);
      var exclusive = this._bouncingMotion.bouncingOptions.exclusive;
      L2.Marker.prototype._orchestration.addBouncingMarker(this, exclusive);
      return this;
    },
    /**
    ...
    stopBouncing: function stopBouncing() {
      ...
      L2.Marker.prototype._orchestration.removeBouncingMarker(this);
      return this;
    },
    /**
    ...
    isRealMarker: function isRealMarker() {
      return this.__proto__ === L2.Marker.prototype;
    },
  ...
  function calculateLine(x, y, angle, length) {
    var xD = Math.round(x + Math.cos(angle) * (length * 2)), yD = Math.round(y + Math.sin(angle) * (length * 2)), dx = Math.abs(xD - x), sx = x < xD ? 1 : -1, dy = Math.abs(yD - y), sy = y < yD ? 1 : -1, err = (dx > dy ? dx : -dy) / 2, e2, p = [], i = 0;
    while (true) {
      p.push([x, y]);
      i++;
      if (i === length)
  ...
  var regStyle = /([\w-]+): ([^;]+);/g;
  var Styles = function() {
    function Styles2(styles) {
      _classCallCheck(this, Styles2);
      styles && Object.assign(this, styles);
    }
    _createClass(Styles2, [{
      key: "findOpacity",
      value: function findOpacity(options) {
        this.opacity = (options === null || options === void 0 ? void 0 : options.opacityWhenUnclustered) || (options === null || options === void 0 ? void 0 : options.opacity) || 1;
      }
      /**
      ...
      value: function ofMarker(marker) {
        var styles = Styles2.parse(marker._icon.style.cssText);
  ...
  function resetClasses(element, classes) {
    classes.forEach(function(className) {
      return L2.DomUtil.removeClass(element, className);
    });
    void element.offsetWidth;
    classes.forEach(function(className) {
      return L2.DomUtil.addClass(element, className);
    });
  }
  ...
  var BouncingMotionCss3 = function() {
    function BouncingMotionCss32(marker, position, bouncingOptions) {
      var _this = this;
      _classCallCheck(this, BouncingMotionCss32);
    ...
    _createClass(BouncingMotionCss32, [{
      ...
      value: function updateBouncingOptions(options) {
        ...
        if (this.bouncingOptions.elastic && this.bouncingOptions.contractHeight) {
          ...
          if (this.marker._icon) {
            L2.DomUtil.removeClass(this.marker._icon, "simple");
          }
        } else {
          ...
          if (!_classPrivateFieldGet(this, _eventCounter)) {
            ...
            if (this.isBouncing && (_classPrivateFieldGet(this, _times) === null || _classPrivateFieldSet(this, _times, (_this$times = _classPrivateFieldGet(this, _times), --_this$times)))) {
              ...
              _classPrivateFieldGet(this, _classes).forEach(function(className) {
                L2.DomUtil.removeClass(_this2.marker._icon, className);
                if (_this2.marker._shadow) {
                  L2.DomUtil.removeClass(_this2.marker._shadow, className);
                }
              });
      ...
      value: function resetStyles(marker) {
        var _this$marker$getIcon, _this$marker$getIcon$, _this$marker, _this$marker$_iconObj, _this$marker$_iconObj2, _this3 = this;
        this.marker = marker;
        ...
        var iconAnimationParams = BouncingMotionCss32.animationParams(this.position, this.bouncingOptions, iconHeight);
        ...
        var _this$bouncingOptions = this.bouncingOptions, bounceHeight = _this$bouncingOptions.bounceHeight, contractHeight = _this$bouncingOptions.contractHeight, shadowAngle = _this$bouncingOptions.shadowAngle;
        if (this.marker._shadow) {
          if (shadowAngle) {
            var _this$marker$getIcon2, _this$marker$getIcon3;
            var _this$position = this.position, x = _this$position.x, y = _this$position.y;
            var points = calculateLine(x, y, shadowAngle, bounceHeight + 1);
            var _points$bounceHeight = _slicedToArray(points[bounceHeight], 2), posXJump = _points$bounceHeight[0], posYJump = _points$bounceHeight[1];
            ...
            var shadowScaleContract = BouncingMotionCss32.contractScale(shadowHeight, contractHeight);
            ...
            _classPrivateFieldGet(this, _classes).forEach(function(className) {
              L2.DomUtil.removeClass(_this3.marker._shadow, className);
            });
          }
        }
      }
      ...
      value: function animationParams(position, bouncingOptions, height) {
        ...
        var bounceHeight = bouncingOptions.bounceHeight, contractHeight = bouncingOptions.contractHeight, bounceSpeed = bouncingOptions.bounceSpeed, contractSpeed = bouncingOptions.contractSpeed;
        var scaleContract = BouncingMotionCss32.contractScale(height, contractHeight);
        var durationJump = BouncingMotionCss32.calculateDuration(bounceHeight, bounceSpeed);
        var durationContract = BouncingMotionCss32.calculateDuration(contractHeight, contractSpeed);
    ...
    return BouncingMotionCss32;
  }();
  L__default["default"].Marker.include(MarkerPrototypeExt);
  L__default["default"].Marker.setBouncingOptions = function(options) {
    L2.Marker.prototype._bouncingOptions = options instanceof BouncingOptions ? options : new BouncingOptions(options);
  };
  L__default["default"].Marker.getBouncingMarkers = function() {
    L2.Marker.prototype._orchestration.getBouncingMarkers();
  };
  L__default["default"].Marker.stopAllBouncingMarkers = function() {
    L2.Marker.prototype._orchestration.stopAllBouncingMarkers();
  };
  L__default["default"].Marker.addInitHook(function() {
    if (this.isRealMarker()) {
      var bouncingOptions = new BouncingOptions(L2.Marker.prototype._bouncingOptions);
      this._bouncingMotion = new BouncingMotionCss3(this, new L2.Point(0, 0), bouncingOptions);
    }
  });
})(L);
//# sourceMappingURL=leaflet__smooth_marker_bouncing.js.map
